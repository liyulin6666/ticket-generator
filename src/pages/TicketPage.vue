<template>
  <div style="padding: 20px; text-align: center;">
    <img v-show="false" ref="templateRef" src="/template.png" style="width: 300px;" />

    <div style="margin: 20px 0;">
      <input v-model="name" placeholder="请输入名字" style="padding: 10px; width: 200px;" />
    </div>
...
const generate = () => {
  ...
  ctx.fillText(name.value, canvas.width / 2, canvas.height - 300);
